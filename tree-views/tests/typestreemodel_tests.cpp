...
void TypesTreeModelTests::test_modelWithDummyPopulation()
{
    ...
    auto file2 = std::make_unique<Data::File>("file2.asn1");
    {
        ...
        definitions1->add(std::make_unique<Data::TypeAssignment>("Num10", Data::SourceLocation{"file2.asn1", 2, 3}, Data::Types::BuiltinType::createBuiltinType("IntegerType")));
    ...
    auto file3 = std::make_unique<Data::File>("file3.asn1");
    {
        ...
        definitions1->add(std::make_unique<Data::TypeAssignment>("Num20", Data::SourceLocation{"file3.asn1", 2, 3}, Data::Types::BuiltinType::createBuiltinType("IntegerType")));

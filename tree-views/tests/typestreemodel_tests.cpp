...
void TypesTreeModelTests::test_modelWithDummyPopulation()
{
    ...
    auto file2 = std::make_unique<Data::File>(Data::Source("file2.asn1", "CONTENTS"));
    {
        ...
        definitions1->add(std::make_unique<Data::TypeAssignment>("Num10", Data::SourceLocation{"file2.asn1", 2, 3}, Data::Type::Kind::UserDefined));
    ...
    auto file3 = std::make_unique<Data::File>(Data::Source("file3.asn1", "CONTENTS"));
    {
        ...
        definitions1->add(std::make_unique<Data::TypeAssignment>("Num20", Data::SourceLocation{"file3.asn1", 2, 3}, Data::Type::Kind::UserDefined));

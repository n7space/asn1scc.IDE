...
{
    auto file1 = std::make_unique<Data::File>(Data::Source("file1.asn1"));
    {
    ...
    auto file2 = std::make_unique<Data::File>(Data::Source("file2.asn1"));
    {
    ...
    auto file3 = std::make_unique<Data::File>(Data::Source("file3.asn1"));
    {

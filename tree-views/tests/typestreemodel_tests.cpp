...
void TypesTreeModelTests::test_modelWithDummyPopulation()
{
    auto file1 = std::make_unique<Data::File>(Data::Source("file1.asn1", "CONTENTS"));
    {
        ...
        definitions1->add(std::make_unique<Data::TypeAssignment>("Num1", Data::SourceLocation{"file1.asn1", 2, 3}, std::make_unique<Data::BuiltinType>("INTEGER")));
        definitions1->add(std::make_unique<Data::TypeAssignment>("Num2", Data::SourceLocation{"file1.asn1", 3, 3}, std::make_unique<Data::BuiltinType>("INTEGER")));
        ...
        definitions2->add(std::make_unique<Data::TypeAssignment>("Num3", Data::SourceLocation{"file1.asn1", 6, 3}, std::make_unique<Data::BuiltinType>("INTEGER")));
        definitions2->add(std::make_unique<Data::TypeAssignment>("Num4", Data::SourceLocation{"file1.asn1", 7, 3}, std::make_unique<Data::BuiltinType>("INTEGER")));
    ...
    auto file2 = std::make_unique<Data::File>(Data::Source("file2.asn1", "CONTENTS"));
    {
        ...
        definitions1->add(std::make_unique<Data::TypeAssignment>("Num10", Data::SourceLocation{"file2.asn1", 2, 3}, std::make_unique<Data::BuiltinType>("INTEGER")));
    ...
    auto file3 = std::make_unique<Data::File>(Data::Source("file3.asn1", "CONTENTS"));
    {
        ...
        definitions1->add(std::make_unique<Data::TypeAssignment>("Num20", Data::SourceLocation{"file3.asn1", 2, 3}, std::make_unique<Data::BuiltinType>("INTEGER")));

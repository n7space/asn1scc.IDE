...
std::unique_ptr<ProposalBuiltinsProvider> AsnCompletionAssistProcessor::getBuiltinsProposalsProvider() const
{
    auto provider = std::make_unique<AsnProposalBuiltinsProvider>();
